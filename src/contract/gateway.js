...
module.exports = {
  ...
  async depositBail(gatewayName, amount) {
    ...
    if ((lockAccount.xas + amount) < app.util.constants.initialDeposit) return `Deposit amount should be greater than ${app.util.constants.initialDeposit - lockAccount.xas}`
