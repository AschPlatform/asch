...
before(async function () {
    var res = await node.openAccountAsync({ secret: Account1.password, secondSecret: Account1.secondPassword })
...
describe('GET /api/transactions', function () {
    ...
    it('Using completely invalid fields. Should fail', function (done) {
        var senderId = 'notAReadAddress', blockId = 'about5', recipientId = 'XASLIOnair3', limit = 'aLOT', offset = 'Boris', orderBy = 't_blockId:asc';
